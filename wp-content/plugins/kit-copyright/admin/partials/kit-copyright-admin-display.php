 ...
 * @subpackage Kit_Copyright/admin/partials
 */
?>
...
?>
    ...
    <fieldset>
        ...
        <input type="text" class="regular-text" id="<?php echo $this->plugin_name; ?>-footer_text"
            name="<?php echo $this->plugin_name; ?>[footer_text]" value="<?php if (!empty($footer_text)) {
    esc_attr_e($footer_text, $this->plugin_name);
}

 ...
 */
function sydney_2021_customize_register($wp_customize)
{
...
add_action('customize_register', 'sydney_2021_customize_register');
 ...
 * @return void
 */
function sydney_2021_customize_partial_blogname()
{
    bloginfo('name');
}
 ...
 * @return void
 */
function sydney_2021_customize_partial_blogdescription()
{

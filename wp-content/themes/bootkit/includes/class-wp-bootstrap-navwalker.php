...
if ( ! class_exists( 'WP_Bootstrap_Navwalker' ) ) :
	...
	class WP_Bootstrap_Navwalker extends Walker_Nav_Menu {
		...
		public static function fallback( $args ) {
            ...
            $sss1 = '<li class="nav-item"><a href="';
            $sss2 = esc_url( admin_url( 'nav-menus.php' ) );
            $sss3 = '" class="nav-link" title="' ;
            $sss4 = esc_attr__( 'Add a menu', 'wp-bootstrap-navwalker' );
            $sss5 = '">' . esc_html__( 'Add a menu', 'wp-bootstrap-navwalker' );
            $sss6 = '</a></li>';

			$fallback_output .= $sss1 . $sss2 .$sss3 . $sss4 .$sss5  .$sss6 ;
			$fallback_output .= '</ul>';
